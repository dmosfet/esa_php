...
<input type="text" name="name" placeholder="Nom de la tâche" value="<?php echo $name;?>" pattern="[A-Za-z\s\-]+" required/>
...
<input type="text" name="tags" placeholder="Catégories" value="<?php echo $tags;?>"/>
</body>
</html>